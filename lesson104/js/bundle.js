...
function calc() {
    ...
    getStaticInformation('#gender div', 'calculating__choose-item_active'); //div уточняет к каким блокам мы обращаемся
...
window.addEventListener("DOMContentLoaded", () => {
    ...
    const modalTimerId = setTimeout(()=> (0,_modules_modal__WEBPACK_IMPORTED_MODULE_2__.openModal)('.modal',modalTimerId), 45000);

    //Tabs=============================================
    (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_0__["default"])(".tabheader__item", ".tabcontent", ".tabheader__items", "tabheader__item_active");
    //Timer============================================
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_1__["default"])(".timer", "2022-06-16");
    //Modal============================================
